...
public final class Bits64TestSelf {
    @Test
...
//            System.out.println(sizes[i]);
            //System.out.println(Long.toBinaryString(rng.nextLong(1L << sizes[i])));
            // issue with the 1L << sizes[i] when sizes[i] == 63
            if(sizes[i] == 63) {
                values[i] = Long.MAX_VALUE;
            } else {
                values[i] = (long) rng.nextLong(1L << sizes[i]);
            }
//            System.out.println(Long.toBinaryString(values[i]));
        }
    ...
    void pack2Works() {
        ...
        for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
            ...
            System.out.println(Long.toBinaryString(v[0]));
            System.out.println(Long.toBinaryString(v[1]));
